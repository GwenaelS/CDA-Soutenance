    ...
    return (
        <div className="bg-[#140030]/50 border border-[#9D4EDD]/75 rounded-xl p-6 flex flex-col">
            ...
            <div className="space-y-2 max-h-[350px] overflow-y-auto pr-1">
                {words.length === 0 ? (
                    <div className="text-center text-base text-[#8e7aab]/60 py-8">
                    ...
                    words.map((wordObj) => (
                        ...
                        >
                            <span className="text-base font-semibold text-[#cfd9e8] break-all mr-4">
                                {wordObj.word}
                            </span>
                            <div className="flex items-center gap-3 shrink-0">
                                <span className="text-base text-[#8e7aab]">
                                    {wordObj.addedAt}
                                </span>
                                <button
