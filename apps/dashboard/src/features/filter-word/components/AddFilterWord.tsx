        ...
        <div className="bg-[#140030]/80 border border-border/40 rounded-xl p-6">
            ...
            <div className="flex gap-3">
                <input
                    ...
                    className="flex-1 bg-[#0c0020]/60 border border-purple-500/20 rounded-lg px-4 py-3 text-sm text-[#cfd9e8] placeholder-[#8e7aab]/40 focus:outline-none focus:border-purple-500/50 transition-colors"
                />
                <button
                    onClick={handleAdd}
                    disabled={!newWord.trim()}
                    className="bg-[#24133f] hover:bg-[#2f1b52] disabled:opacity-50 text-[#cfd9e8] border border-purple-500/20 font-semibold px-6 py-2.5 rounded-lg text-sm transition-all cursor-pointer disabled:cursor-not-allowed">
                    Ajouter
                </button>
            </div>
        </div>
