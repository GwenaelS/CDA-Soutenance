    ...
    beforeEach(async () => {
        const module: TestingModule = await Test.createTestingModule({
            providers: [
                ...
                { provide: getRepositoryToken(Filtered_word), useValue: mockFilteredWordRepository },
                { provide: getRepositoryToken(Exempted_role), useValue: mockExempteRoleRepository },
            ],
        }).compile();
